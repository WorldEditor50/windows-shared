#ifndef CRASHDUMP_HPP
#define CRASHDUMP_HPP
...
public:
    ...
    CrashDump(): oldExceptionFilter(NULL)
    {
        // 堆异常
        ...
        oldExceptionFilter = ::SetUnhandledExceptionFilter(UnhandledExceptionFilter);
